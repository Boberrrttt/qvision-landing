...
const HeroSection = () => {
  ...
  return (
    <section id="home" className="flex w-full flex-col pt-24 pb-10 md:py-48 justify-center items-center bg-gradient-to-r from-[#ededed] from-0% via-[#ededed] via-30% to-white to-50%">
      {/* Main Hero Section */}
