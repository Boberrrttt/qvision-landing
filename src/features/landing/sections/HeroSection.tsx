...
const HeroSection = () => {
  return (
    <div className="flex w-full flex-col pt-16 pb-10 md:pt-24 md:pb-16 justify-center items-center bg-gradient-to-r from-[#ededed] from-0% via-[#ededed] via-30% to-white to-50%">
      {/* Main Hero Section */}
