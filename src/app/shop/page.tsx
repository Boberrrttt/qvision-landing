...
const ShopPage = () => {
  ...
  const handleNotify = async () => {
    ...
    try {
      ...
      await axios.post("/api/notify", { email: trimmedEmail });
  ...
  return (
    <section
      id="shop"
      className="relative flex flex-col justify-center h-full md:justify-start md:flex-row px-6 md:px-28 py-10 md:py-0 items-center bg-gradient-to-r from-[#ededed] via-[#ededed] to-white"
    >
      {/* Text Section */}
      <div className="flex flex-col w-full max-w-[800px] justify-start text-center md:text-left z-10">
        ...
        <button
          ...
          disabled={isSending}
          className="w-full sm:w-[40%] md:w-[20%] cursor-pointer mt-3 bg-[#192B4B] text-sm md:text-base text-white py-3 md:py-4 rounded-lg">
        ...
        {message && (
          <p
            className={`mt-4 text-sm sm:text-base italic ${
        ...
        <div className="flex justify-center md:justify-start flex-row gap-3 mt-4">
          <a href="https://www.facebook.com/profile.php?id=61574997554727" target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://instagram.com/byteq.ph" target="_blank" rel="noopener noreferrer">
            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24">
              <path
                fill="#000"
